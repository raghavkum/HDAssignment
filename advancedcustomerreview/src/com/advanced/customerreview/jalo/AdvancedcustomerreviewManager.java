 ...
 *  
 */
package com.advanced.customerreview.jalo;
...
import com.advanced.customerreview.constants.AdvancedcustomerreviewConstants;



/**
 * This is the extension manager of the Advancedcustomerreview extension.
 */
public class AdvancedcustomerreviewManager extends GeneratedAdvancedcustomerreviewManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdvancedcustomerreviewManager.class.getName());
	 ...
	 */
	public static AdvancedcustomerreviewManager getInstance()
	{
		return (AdvancedcustomerreviewManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdvancedcustomerreviewConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdvancedcustomerreviewManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdvancedcustomerreviewManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdvancedcustomerreviewManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdvancedcustomerreviewManager called, current tenant: " + getTenant().getTenantID());
		}
	}
